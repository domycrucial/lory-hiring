...
INSERT INTO `users` (`full_name`, `email`, `phone`, `password_hash`, `role`, `email_verified_at`, `wallet_balance`, `status`) VALUES
  ...
  ('System Administrator', 'superadmin@olhs.co.tz', '+255700000001',
   '$2y$12$AlLmle6ibUXx5BOzo/xCIOK5OUAV.LhYyu7C15aka2zEeYHujR2aC', 'super_admin', NOW(), 0.00, 'active'),

  -- Admin
  ('Platform Admin', 'admin@olhs.co.tz', '+255700000002',
   '$2y$12$AlLmle6ibUXx5BOzo/xCIOK5OUAV.LhYyu7C15aka2zEeYHujR2aC', 'admin', NOW(), 0.00, 'active'),

  -- Lorry Owner 1
  ('Juma Hassan Salim', 'juma.owner@gmail.com', '+255712345678',
   '$2y$12$AlLmle6ibUXx5BOzo/xCIOK5OUAV.LhYyu7C15aka2zEeYHujR2aC', 'lorry_owner', NOW(), 125000.00, 'active'),

  -- Lorry Owner 2
  ('Fatuma Rashid', 'fatuma.owner@gmail.com', '+255723456789',
   '$2y$12$AlLmle6ibUXx5BOzo/xCIOK5OUAV.LhYyu7C15aka2zEeYHujR2aC', 'lorry_owner', NOW(), 87500.00, 'active'),

  -- Customer 1
  ('Ali Mohamed Kimaro', 'ali.customer@gmail.com', '+255754321098',
   '$2y$12$AlLmle6ibUXx5BOzo/xCIOK5OUAV.LhYyu7C15aka2zEeYHujR2aC', 'customer', NOW(), 0.00, 'active'),
